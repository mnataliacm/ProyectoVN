            ...
            <table class="table table-striped table-verde">
              <form method="post" action="nuevaActividad.jsp">
                <tr class="table-warning">
                  <td><input type="text" name="IDact" size="5" placeholder="<% %>" readonly></td>
                  <td><input type="text" name="IDcat" size="5" placeholder="IDcat" required></td>
                  <td><input type="text" name="IDciu" size="5" placeholder="IDciu" required></td>
                  <td><input type="text" name="NomAct" size="40" placeholder="Actividad" required></td>
                  <td><input type="text" name="IDemp" size="5" placeholder="Empresa" required></td>
                  <td><input type="text" name="Horario" size="40" placeholder="Horario" required></td>
                  <td><input type="text" name="Info" size="40" placeholder="Información"></td>
                  <td>
