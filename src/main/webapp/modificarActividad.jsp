              ...
              <form method="post" action="editarRegistros.jsp">
                <div class="card-body bg-naranja">
                  <div class="row">
                    ...
                    <div class="col"> 
                      <label>Categoria <input type="text" size="25" name="IDcat" value="<%= request.getParameter("IDcat") %>" required></label>
                    </div>
                    <div class="col"> 
                    ...
                    <div class="col">
                      <label>Empresa <input type="text" size="35" name="IDemp" value="<%= request.getParameter("IDemp") %>" ></label>
                    </div>
                    <div class="col">
